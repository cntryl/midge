...
// CountingFilter â€” counts invocations
...
fn should_invoke_filter_for_each_key_given_compaction_with_custom_filter() {
    for mode in disk_storage_modes() {
        ...
        // produce >1 SST â†’ compaction always happens
...
// PrefixRemovalFilter â€” drops keys starting with prefix
...
// KeepAllFilter â€” ensures compaction is non-destructive
