...
fn should_not_see_uncommitted_write_given_other_transaction_when_read() {
    ...
    assert!(result.is_none(), "Uncommitted writes invisible to other transactions");
}
