...
fn should_isolate_keys_given_same_key_in_different_cfs_when_reading() {
    for_each_storage_mode(&all_storage_modes_new(), |mode, opts| {
        ...
        tx_default
            ...
            .unwrap();
        engine
            .commit(tx_default, cntryl_midge::WriteOptions::buffered())
            .unwrap();
        ...
        tx_cf1
            ...
            .unwrap();
        engine
            .commit(tx_cf1, cntryl_midge::WriteOptions::buffered())
            .unwrap();
...
fn should_isolate_deletes_given_delete_in_one_cf_when_other_cf_has_same_key() {
    for_each_storage_mode(&all_storage_modes_new(), |mode, opts| {
        ...
        engine
            .commit(tx_del, cntryl_midge::WriteOptions::buffered())
            .unwrap();
...
fn should_isolate_data_given_different_data_volumes_when_reading() {
    for_each_storage_mode(&all_storage_modes_new(), |mode, opts| {
        ...
        tx_cf2
            ...
            .unwrap();
        engine
            .commit(tx_cf2, cntryl_midge::WriteOptions::buffered())
            .unwrap();
