            ...
            Err(_) => {
                ...
                match self.result.load(Acquire) {
                    ...
                    2 => {
                        ...
                        Err(MidgeError::internal("group-commit leader fsync failed"))
                    }
                    0 => {
                        ...
                        match self.result.load(Acquire) {
                            1 => Ok(()),
                            2 => Err(MidgeError::internal("group-commit leader fsync failed")),
...
mod tests {
    ...
    fn should_create_coordinator_with_default_config() {
        ...
        let coordinator = GroupCommitCoordinator::new(config);
