...
const LOOKUP_BATCH_SIZE: usize = 32_768;
const LOOKUP_BATCH_OPS: u64 = 32_768;
...
fn get_hit(ctx: &mut StressContext) {
    ...
    stress_config::measure_hot_path_batch(ctx, "get_hit", LOOKUP_BATCH_OPS, || {
        let mut hits = 0usize;
...
fn get_miss(ctx: &mut StressContext) {
    ...
    stress_config::measure_hot_path_batch(ctx, "get_miss", LOOKUP_BATCH_OPS, || {
